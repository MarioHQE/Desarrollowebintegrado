    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.cors(t -> t.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/pedido/pedido/{idpedido}").hasAnyRole("USER", "ADMIN")

                        // Proceso de pago (usuarios pueden iniciar pagos)
                        .requestMatchers("/pago/url/{idpedido}").hasAnyRole("USER", "ADMIN")

                        // Perfil de usuario
                        .requestMatchers("/api/usuario/update/{id_usuario}").hasAnyRole("USER", "ADMIN")
                        ...
                        // Consultas de stock (solo lectura para usuarios, control total para admins)
